...
public class SeleniumTest {
    ...
    void testcategoriElectronicsProductsDisplayedOnClick() {
        ...
        // Verify that there are 6 product items on the page
    ...
    void testcategoriJeweleryProductsDisplayedOnClick() {
        ...
        // Find and click on the electronics category link
        WebElement electronicsLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("jewelery")));
        electronicsLink.click();
    ...
    void testcategoriMensClothingProductsDisplayedOnClick() {
        ...
        // Find and click on the electronics category link
        WebElement electronicsLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("men's clothing")));
        electronicsLink.click();
    ...
    void testcategoriWomensClothingProductsDisplayedOnClick() {
        ...
        // Find and click on the electronics category link
        WebElement electronicsLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("women's clothing")));
        electronicsLink.click();
